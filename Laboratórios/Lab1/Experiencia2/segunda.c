...
/* Trabalhando com outra macro (__delay_ms(x))deve-se definir a FCY antes da 
   ...
   e se obterá o valor certo em ms. Temos outra macro para mi bvbvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvcro segundos (us)
